...
func serviceLogger( _ message : String = "" , file: String = #file, function: String = #function, line: Int = #line) {
    print(" 🤨 Service Log : Message : \(message == "" ? "Logger from" : message) , File : \(file)  called from : \(function) , line number : \(line) 🤨")
}
